...
public class HuespedBuscar extends javax.swing.JInternalFrame {


    public HuespedBuscar() {
        initComponents();
    ...
    private void jbSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSeleccionarActionPerformed
        ...
        adminHuesped.jtfID.setText(huesped1.getIdHuesped()+"");
        adminHuesped.jtfNombre.setText(huesped1.getNombre());
        adminHuesped.jtfDNI.setText(huesped1.getDni()+"");
        adminHuesped.jtfDomicilio.setText(huesped1.getDomicilio());
        adminHuesped.jtfCorreo.setText(huesped1.getCorreo());
        adminHuesped.jtfCelular.setText(huesped1.getCelular());
