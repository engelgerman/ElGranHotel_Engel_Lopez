...
public class CICOReservaListar extends javax.swing.JInternalFrame {


    public CICOReservaListar() {
        initComponents();
    ...
    private void jbSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSeleccionarActionPerformed
        ...
        if(fila != -1){
            ...
            cico.reserva = reserva1;
            cico.huesped = reserva1.getHuesped();
            cico.habitacion = reserva1.getHabitacion();
                       
            cico.jtfNumeroReserva.setText(reserva1.getNumeroReserva()+"");
            cico.jtfFEntrada.setText(reserva1.getFechaEntrada().format(formatter2));
            cico.jtfFSalida.setText(reserva1.getFechaSalida().format(formatter2));
            cico.jtfDias.setText(reserva1.getCantidadDias()+"");
            ...
            cico.jtfNombre.setText(reserva1.getHuesped().getNombre());
            cico.jtfDNI.setText(reserva1.getHuesped().getDni()+"");
            
            cico.jtfNumero.setText(reserva1.getHabitacion().getNumeroHabitacion()+"");
            cico.jtfMaxP.setText(reserva1.getHabitacion().getTipoHabitacion().getCantidadPersonas()+"");
            
            cicoResListar.dispose();
                   
        }else{
            JOptionPane.showMessageDialog(null, "No se selecciono ninguna reserva", "Seleccionar", JOptionPane.WARNING_MESSAGE);
        }               
